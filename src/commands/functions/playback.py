...
def go_executor(
    ...
    *,
    ...
    Examples:
        ...
        'go executor 1 + 2 + 3'
    """
    return go("executor", executor_id, end=end, cue_mode=cue_mode, userprofile=userprofile)
...
def go_back_executor(
    ...
    *,
    ...
    Examples:
        ...
        'goback executor 3'
    """
    return go_back("executor", executor_id, end=end, cue_mode=cue_mode, userprofile=userprofile)
